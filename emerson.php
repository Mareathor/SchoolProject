...
?>
	...
	<br><br><br><br>
		...
		<tr>
		    <td/>
		    <td> <img src="Emerson.jpg" width= "400"> </img></td>
		    <td> <b><font size= "7"> Emerson </font></b><br>&euro; 458,85<br> 
			<i><br> Emerson is een casual suéde schoen met een lage hak voor een vlotte look. <br>
			Juist door deze suede bekleding komt de schoen nonchalant over.<br>
			Door het elastische detail kan men gemakkelijk de schoen betreden en voelt het comfortabel. </i>
			<br> <br> 
			Zool: Rubber 100% <br>
...
if (empty($id)){} else
    echo
    '<form action="FavorietenMand/FavorietenVrouwen3.php">
    <button> favorieten </button>
	</form>
	<br><br>
	<form action="FavorietenMand/MandVrouwen3.php">
