...
?>
	...
	<br><br><br><br>
		...
		<tr>
		    <td/>
		    <td> <img src="Florian.jpg" width= "400"> </img></td>
		    <td> <b><font size= "7"> Florian </font></b><br>&euro; 240,43<br> 
			<i><br> Deze bootschoen van leer is geschikt voor een alledaagse outfit maar ook voor een avondje uit. <br>
			Het contrast tussen zwart wit geef een stoere look in combinatie met het leer. </i>
			<br> <br> 
			Zool: Rubber 100% <br>
...
if (empty($id)){} else
    echo
    '<form action="FavorietenMand/FavorietenMannen2.php">
    <button> favorieten </button>
	</form>
	<br><br>
	<form action="FavorietenMand/MandMannen2.php">
