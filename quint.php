...
?>
	...
	<br><br><br><br>
		...
		<tr>
		    <td/>
		    <td> <img src="Quint.jpg" width= "400"> </img></td>
		    <td> <b><font size= "7"> Quint </font></b><br>&euro; 121,84<br> 
			<i><br> Deze leren bootschoenen zijn perfect te combineren. <br>
			Met een simpele spijkerjeans geeft het een alledaags effect maar wanneer
			men het <br>
			combineert met een donkere broek is het ook uitermate perfect voor de avond.
			De studs op de neus maken de schoen specialer en nog wat stoerder.  </i>
			<br> <br> 
			Zool: Rubber 100% <br>
...
if (empty($id)){} else
    echo
    '<form action="FavorietenMand/FavorietenMannen6.php">
    <button> favorieten </button>
	</form>
	<br><br>
	<form action="FavorietenMand/MandMannen6.php">
