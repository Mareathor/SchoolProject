...
?>
	...
	<br><br><br><br>
		...
		<tr>
		    <td/>
		    <td> <img src="Taylor.jpg" width= "400"> </img></td>
		    <td> <b><font size= "7"> Taylor </font></b><br>&euro; 339,23<br> 
			<i><br> Deze bootschoen is vooral geschikt voor overdag. <br>
			Een zomerse tint maakt deze schoen leuk voor bijvoorbeeld het strand. </i>
			<br> <br> 
			Zool: Rubber 100% <br>
...
if (empty($id)){} else
    echo
    '<form action="FavorietenMand/FavorietenMannen4.php">
    <button> favorieten </button>
	</form>
	<br><br>
	<form action="FavorietenMand/MandMannen4.php">
