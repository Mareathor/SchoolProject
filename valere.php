...
?>
	...
	<br><br><br><br>
		...
		<tr>
		    <td/>
		    <td> <img src="Valere.jpg" width= "400"> </img></td>
		    <td> <b><font size= "7"> Valere </font></b><br>&euro; 195,94<br> 
			<i><br> Deze schoen is ontworpen door onze feest- en festivalstylisten.<br>
			De suede look geeft het festivaleffect en de hak en openingen aan de zijkant geven juist
			weer het klassieke en feestelijke effect </i>
			<br> <br> 
			Zool: Rubber 100% <br>
...
if (empty($id)){} else
    echo
    '<form action="FavorietenMand/FavorietenVrouwen6.php">
    <button> favorieten </button>
	</form>
	<br><br>
	<form action="FavorietenMand/MandVrouwen6.php">
